...
export default function PropertyMap({ latitude, longitude, name, address }: PropertyMapProps) {
  ...
  if (!valid) {
    return (
      <div className="rounded-2xl bg-page border border-neutral-200 flex flex-col items-center justify-center py-12 gap-3">
  ...
  return (
    <div className="rounded-2xl overflow-hidden border border-neutral-200 bg-white/80 shadow-card">
      {/* Header */}
      ...
      {/* Footer */}
      <div className="px-4 py-2 bg-page border-t border-neutral-100 flex items-center justify-between">
